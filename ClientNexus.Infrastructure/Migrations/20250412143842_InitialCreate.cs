...
namespace ClientNexus.Infrastructure.Migrations
{
    ...
    public partial class InitialDatabase : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "ClientNexusSchema");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentGateway = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DetailedAddress = table.Column<string>(
                        type: "nvarchar(200)",
                        maxLength: 200,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsApproved = table.Column<bool>(
                        type: "bit",
                        nullable: false,
                        defaultValue: false
                    ),
                    IsAvailableForEmergency = table.Column<bool>(
                        type: "bit",
                        nullable: false,
                        defaultValue: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_DocumentCategories",
                        x => new { x.DocumentId, x.DCategoryId }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey(
                        "PK_AppointmentCosts",
                        x => new { x.ServiceProviderId, x.AppointmentType }
                    );
                    table.ForeignKey(
...
<<<<<<<< HEAD:ClientNexus.Infrastructure/Migrations/20250414191103_InitialDatabase.cs
                },
                constraints: table =>
                {
                    table.PrimaryKey(
                        "PK_ClientServiceProviderFeedbacks",
                        x => new { x.ServiceProviderId, x.ClientId }
                    );
========
...
>>>>>>>> 1bf35a96a004a3f9aabc05257b5049636fbf72aa:ClientNexus.Infrastructure/Migrations/20250412143842_InitialCreate.cs
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_ServiceProviderSpecializations",
                        x => new { x.ServiceProviderId, x.SpecializationId }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.Sql(
                @"
                CREATE SPATIAL INDEX IX_ServiceProviders_CurrentLocation ON ClientNexusSchema.ServiceProviders(CurrentLocation);
                "
            );

            migrationBuilder.Sql(
                @"
                CREATE SPATIAL INDEX IX_EmergencyCases_MeetingLocation ON ClientNexusSchema.EmergencyCases(MeetingLocation);
                "
            );
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                @"
                DROP INDEX IX_ServiceProviders_CurrentLocation ON ClientNexusSchema.ServiceProviders;
                "
            );

            migrationBuilder.Sql(
                @"
                DROP INDEX IX_EmergencyCases_MeetingLocation ON ClientNexusSchema.EmergencyCases;
                "
            );
            ...
            migrationBuilder.DropTable(name: "Addresses", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AppointmentCosts", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Appointments", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AspNetRoleClaims", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AspNetUserClaims", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AspNetUserLogins", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AspNetUserRoles", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AspNetUserTokens", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "CaseFiles", schema: "ClientNexusSchema");
            ...
            migrationBuilder.DropTable(name: "DocumentCategories", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "EmergencyCases", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "EmergencyCategories", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "OfficeImageUrls", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "PhoneNumbers", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Problems", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Questions", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "ServicePayments", schema: "ClientNexusSchema");
            ...
            migrationBuilder.DropTable(name: "SubscriptionPayments", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Cities", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Slots", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AspNetRoles", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "ConsultationCases", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "DCategories", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Documents", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Specializations", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Payments", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "States", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Services", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "DocumentTypes", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Countries", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Clients", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "ServiceProviders", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "ServiceProviderTypes", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "BaseUsers", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "Admins", schema: "ClientNexusSchema");

            migrationBuilder.DropTable(name: "AccessLevels", schema: "ClientNexusSchema");
        }
    }
}
